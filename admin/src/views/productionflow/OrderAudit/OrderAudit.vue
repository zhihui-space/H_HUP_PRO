...
export default {
  ...
  components: { Table, CommitDialog, ProductionFlowOrderAuditFileDetails, OrderConstractProductSel, OrderProductInfoDetails },
  data() {
    return {
      content: {
