  ...
  <div>
    ...
    <el-row>
      ...
      <div class="icon">
        ...
        <i class="el-icon-s-home"><span>全部入库</span></i>
      </div>
...
import { selectAllMaterielPutinWareAsPage, updateMaterielPutinWare } from '@/api/orderCompMage/OrderRepertory'
import { materielPutinProccess } from '@/api/orderCompMage/orderCompMage'

export default {
  name: "ProductionFlowOrderRepertoryView",
  components: { Table, CommitDialog, ProductionFlowOrderRepertoryContent, OrderConstractProductSel, OrderProductInfoDetails },
  data() {
    return {
      content: {
  ...
  methods: {
    ...
    onButtonClick(param, btnCode, unexParam) {
      ...
      if (param.btnCode === 'OVERREPERTORY') { // 全部入库
